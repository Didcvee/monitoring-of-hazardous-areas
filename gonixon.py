...
# im = Image.open('img_7.png') # ------------------ картинку сюда ---------------
...
for filename in os.listdir(folder_path):
    ...
    if filename.endswith(".jpg") or filename.endswith(".png") or filename.endswith(".jpeg"):
        ...
        # plot_results(im, probas[keep], bboxes_scaled) -----------------
            ...
            with open('data.csv', 'a') as w_file:
                ...
                if (procent > 15):
                    ...
                    # output_path = r'C:\Users\Didcvee\PycharmProjects\pythonProject\cropped_image'+ffff+'.png'
                ...
                file_writer.writerow([f'{folder_path}, "{str(filename)}", "{str(hook)}", "{str(round(procent,2))}"'])
...
# model.predict('chel.jpg', save=True, imgsz=320, conf=0.1)
